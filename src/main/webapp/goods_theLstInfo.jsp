...
<title><s:property value="goods.goodsname" />
</title>
...
<body class="theLostInfo_Body">
	...
	<div class="theLostInfo_InfoBody">
			...
			<div
				...
				<table>
					<tr style="height: 40px;line-height: 40px;">
						<th width="100px"><img src="image/tzico.jpg"></img></th>
						<td
				...
				<table style="height:200px;width: 300px;">
					<tr style="height: 40px;line-height: 40px;">
						<td><img alt="" onerror="this.src='image/lost.png'"
							style="height:160px;width: 300px;border: 1px solid silver ;"
							src="<s:property value="goods.goodspictures" />"></td>
					</tr>
				</table>
				...
				<table style="height: 200px;">
					<tr>
						...
						<td valign="top"><textarea rows="8" readonly="readonly"
								style="width: 500px;resize: none;"><s:property value="goods.goodsdescribe" /></textarea></td>
					</tr>
					...
					<tr style="height: 34px;line-height: 34px;">
						<th>联系人 Q Q:</th>
						<td><u><s:property value="goods.goodsuser.userqq" /> </u></td>
					</tr>
				</table>
		...
		<div class="theLostInfo_comment">
			<form action="comment_NewInfo.action" method="post">
				<font style="height: 32px;line-height: 32px;">联 系 人 : <s:if test="#session.sessionUser!=null"><s:property
				...
				<textarea name="comment.commentcontent" class="commentLostDescribe"
		...
		<s:iterator value="listComment" var="commentInfo">
			<div class="theLostInfo_commentInfo">
