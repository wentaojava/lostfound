...
<body>
	<div class="background">
		...
		<div class="tBody" style="float: left;">
			<div
				style="float: left;margin-top: 5px;width: 920px;margin-left:40px;word-wrap: break-word; word-break: normal;escape:false;text-align: left;">
				<p style="text-align: center;font-size: 24px;">
					<span style=";font-size:24px;font-family:&#39;宋体&#39;">隐私政策</span>
				</p>
				<p style="text-indent:28px">
					<span style=";font-size:14px;font-family:&#39;宋体&#39;">为保证网站正常发展，规避意外风险，从而向广大用户提供更优质的服务，故此特设版权声明。为保证您的知识产权不被侵犯，</span><span
